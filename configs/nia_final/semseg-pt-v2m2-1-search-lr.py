...
hooks = [
    ...
    dict(type="SemSegEvaluatorPerSteps", eval_steps=400),
    dict(type="CheckpointSaverPerSteps", save_steps=400),
...
epoch = 1
eval_epoch = 1
optimizer = dict(type="AdamW", lr=1e-4, weight_decay=0.005)
scheduler = dict(
    type="OneCycleLR",
    max_lr=optimizer["lr"],
    pct_start=0.04,
